...
## Important
There are a of total twenty books provided by the API `BooksAPI.js`. The backend API uses a fixed set of cached search results and is limited to a particular set of search terms found in the [SEARCH_TERMS.md](https://github.com/iliana-p/...."SEARCH_TERMS.md") file.
## Issues
**Search Page**
